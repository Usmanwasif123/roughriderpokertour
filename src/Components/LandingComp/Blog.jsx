...
<stop stopColor="#F3D284"/>
<stop offset="1" stopColor="#F3D284" stopOpacity="0"/>
</linearGradient>
</defs>
</svg>
...
<stop offset="1" stopColor="#F3D284" stopOpacity="0"/>
      ...
      <span className="font-[Cinzel] text-lg lg:text-2xl uppercase 2xl:text-6xl font-bold text-[#DC8F69] uppercase z-40">our</span>
    <h2 className="my-5 font-[Cinzel] text-xl lg:text-6xl uppercase 2xl:text-7xl font-bold text-[#FF0205] uppercase">
    Blogs</h2>
    </div>
  </div>
  <div className="grid w-full grid-rows-1 gap-12 lg:grid-cols-2 mb-28">
