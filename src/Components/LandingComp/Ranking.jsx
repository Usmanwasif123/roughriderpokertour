...
<img src='https://i.ibb.co/BPnyC57/Rectangle-286.png' className="h-full md:h-[100rem] md:w-full" alt='banner'/>
  ...
  <div className="grid w-full grid-cols-1 gap-20 lg:grid-cols-3 -mt-[90rem] z-40">
  <div className="flex flex-col md:flex-row justify-center items-center h-full md:w-104 md:space-x-48">
    <div className="mt-20">
    <img className="mt-5 mb-5 h-40" src="https://i.ibb.co/fXcp3qR/Group-9.png" alt=""/>
      <h2 className="text-2xl lg:text-lg 2xl:text-5xl font-bold uppercase text-[#EEEAF3] mt-5 mb-5">
      Stephank Smith
      </h2>
      </div>
      <div className="">
     <img className="mt-5 mb-5 h-56" src="https://i.ibb.co/1vxtZhC/Group-10.png" alt=""/>
      <h2 className="ml-5 text-2xl lg:text-lg 2xl:text-5xl font-bold uppercase text-[#FFE9CA] mt-5 mb-5">
      Stephank Smith
      </h2>
      </div>
      <div className="mt-20">
    <img className="mt-5 mb-5 h-40" src="https://i.ibb.co/GWjRcjP/Group-11.png" alt=""/>
      <h2 className="text-2xl lg:text-lg 2xl:text-5xl font-bold uppercase text-[#FFE9CA] mt-5 mb-5">
      Stephank Smith
      </h2>
      </div>
      </div>
  ...
  <div className="flex-col justify-center items-center h-full md:w-full">
    ...
    <div className="bg-white rounded-xl grid grid-cols-1 gap-12 lg:grid-cols-5 -mt-131">
      <h2 className="pl-20 text-2xl lg:text-lg 2xl:text-5xl font-bold uppercase text-[#16171D]">
      Makenna Baptista
      </h2>
      ...
      <div className="p-0 md:p-28 -mt-40">
    <img className="-ml-14" src="https://i.ibb.co/vxZ4Xpm/Group-13.png" alt=""/>
    <div className="bg-white rounded-xl grid grid-cols-1 gap-12 lg:grid-cols-5 -mt-131">
      <h2 className="pl-20 text-2xl lg:text-lg 2xl:text-5xl font-bold uppercase text-[#16171D]">
      Makenna Baptista
      </h2>
      ...
      <div className="p-0 md:p-28 -mt-40">
    <img className="-ml-14" src="https://i.ibb.co/C7CswzF/Group-14.png" alt=""/>
    <div className="bg-white rounded-xl grid grid-cols-1 gap-12 lg:grid-cols-5 -mt-131">
      <h2 className="pl-20 text-2xl lg:text-lg 2xl:text-5xl font-bold uppercase text-[#16171D]">
      Makenna Baptista
      </h2>
      ...
      <div className="p-0 md:p-28 -mt-40">
    <img className="-ml-14" src="https://i.ibb.co/9ptRdym/Group-15.png" alt=""/>
    <div className="bg-white rounded-xl grid grid-cols-1 gap-12 lg:grid-cols-5 -mt-131">
      <h2 className="pl-20 text-2xl lg:text-lg 2xl:text-5xl font-bold uppercase text-[#16171D]">
      Makenna Baptista
      </h2>
      ...
      <div className="p-0 md:p-28 -mt-40">
    <img className="-ml-14" src="https://i.ibb.co/6npBBzy/Group-16.png" alt=""/>
    <div className="bg-white rounded-xl grid grid-cols-1 gap-12 lg:grid-cols-5 -mt-131">
      <h2 className="pl-20 text-2xl lg:text-lg 2xl:text-5xl font-bold uppercase text-[#16171D]">
      Makenna Baptista
      </h2>
      ...
      <img className='-mt-100 h-14  hidden md:block' src='https://i.ibb.co/8DzgZ83/Group-4797.png' alt=''/>
